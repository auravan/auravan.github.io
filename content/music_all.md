...
在正式了解音乐世界之前，你真的需要了解一些关键的概念。[泛音列](https://www.bilibili.com/video/BV1AfzmYjENv)我不知道为什么我直到现在才highlight这个概念。![](/harmonylist.png)

我想一路上你已经了解了足够多的音乐分析和代数运算，我需要向你隆重介绍音乐的几何学，Dmitri Tymoczko应该是当代的集大成者。他的

你可以从最物理角度以及十二平均律的角度以及加法合成器的角度以及傅里叶分析的角度来理解音乐，甚至内蕴规律，这太关键了。

- [spiralchrod最新进展](/spiralchorddemov2/v121.html)，项目使用spiralchord方法可视化以及记录和弦。
- 理解[真正的五度圈](/wudu4.html),受到gemini提到的tonnetz启发，相关的进展首先来自对[三叶结的研究](https://observablehq.com/@renatoppl/torus-knots)，其次来自我与deepseek对话音乐内几何-代数-分析时提到的Neo-Riemannian theory。里面环化的tonnetz令人遐想，由此引申。

- demo[网站](/spiralchorddemov2/index.html)一个记录分析midi和弦的工具。
